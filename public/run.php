...
require_once __DIR__ . '/../library/Chessboard/TIterator.php';
require_once __DIR__ . '/../library/Chessboard/TArrayAccess.php';
require_once __DIR__ . '/../library/Chessboard/TCountable.php';
